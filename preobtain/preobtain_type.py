...
def get_description(idx, neigh=0, max_tokens=50):
    ...
    # 定义文件路径
    file_path = r'D:\jinquanxin\LLM4EA\data\FBDB15K\candidates\description1'
    output_file_path = r'D:\jinquanxin\LLM4EA\data\FBDB15K\candidates\description_with_category1_new.json'
    ...
    def process_data(data):
        ...
        for entity_id, entity_info in tqdm(data.items(), desc=f"Processing {idx}"):
            ...
            if response_content:
                ...
                ent_other[entity_id]=entity_info
                print(ent_other)
                write_file_new(ent_other, output_file_path)
            else:
                continue

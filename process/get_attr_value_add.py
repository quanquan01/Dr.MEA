...
# 示例文件路径
entity_file = r'E:\学习资料\mmkb-master\FB15K\FB15K_NumericalTriples.txt'  # 实体文件
id2entity_file = './norm/ent_ids_1'  # id和实体映射文件
output_file = './norm/FB_attr_entity_embeddings.pkl'  # 输出的嵌入文件
